...
const URL = '/social-media-contacts';

/**
 * Servicio para manejar todas las operaciones de la API relacionadas con Contactos de Redes Sociales.
 */
const SocialMediaContactService = {
    ...
    async getAll() {
        try {
            ...
            console.error("Error al obtener la lista de contactos de redes sociales:", error);
...
export default SocialMediaContactService;